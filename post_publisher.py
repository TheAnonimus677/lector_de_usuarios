...
st.markdown('# Publicador de Posts de PeakD')
...
with st.form("my_form"):
    ...
    post_image_url = st.text_input("URL de la imagen (obligatorio si deseas postear imágenes):")
...
if sumbit_button:
   ## if post_image is not None:
    ...
    images_meta = [post_image_url] if is not None post_image_url else []
    ...
    st.success("Post publicado correctamente ✅️")
